...
describe('AProfile Page', () => {

    const mockpassword = { username: 'testapprover', old_pwd: 'mockoldpwd', new_pwd: 'mocknewpwd' }
    ...
    //         </Provider>
    //     )
    //     expect(screen.getByText('UserName: testapprover')).toBeTruthy();
